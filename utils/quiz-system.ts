...
export class QuizSystem {
  ...
  async submitAnswer(
    ...
    const answerRef = push(ref(database, `rooms/${roomId}/quiz/${sessionId}/answers`))
  ...
  async startQuiz(roomId: string, sessionId: string): Promise<void> {
    ...
    const sessionRef = ref(database, `rooms/${roomId}/quiz/${sessionId}/status`)
  ...
  async calculateResults(roomId: string, sessionId: string): Promise<QuizResult[]> {
    ...
    const answersRef = ref(database, `rooms/${roomId}/quiz/${sessionId}/answers`)
