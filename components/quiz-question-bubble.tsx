...
import type { QuizQuestion, QuizAnswer } from "@/utils/quiz-system"
...
export function QuizQuestionBubble({
  ...
  return (
    <div className="max-w-xs mx-auto">
      <div className="bg-gradient-to-br from-purple-900/40 to-blue-900/40 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-1 shadow-2xl">
        {/* Header */}
        ...
        {/* Question */}
        <div className="mb-1">
          <h2 className="text-sm font-medium text-white leading-relaxed">{question.question}</h2>
        </div>
